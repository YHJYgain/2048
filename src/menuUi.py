...
class Game2048:
    def __init__(self, master):
        ...
        self.master.geometry("800x600")  # 设置窗口大小为800x600像素
        ...
        # 设置按钮颜色为浅紫色，选中时为浅黄色
        self.style.map('TButton', background=[('active', '#FFD700'), ('!disabled', '#D8BFD8')], foreground=[('!disabled', '#008000')])  # 设置为葱绿色

        # 添加2048标题，设置字体颜色为葱绿色，并放大两倍
        self.title_label = ttk.Label(self.master, text="2048", font=("Arial", 96, "bold"), foreground="#008000")  # 字体大小放大到96
        ...
        self.style.configure('TButton', font=("Arial", 24))  # 设置按钮字体大小为24
